...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default=r'D:\project\xpx\ultralytics-main\my_seg\images', help='image path dir')
    parser.add_argument('--txt-dir', type=str, default=r'D:\project\xpx\ultralytics-main\my_seg\txt', help='txt path dir')
    parser.add_argument('--save-dir', default=r'D:\Project\xpx\ultralytics-main\my_seg\split', type=str, help='save dir')
