...
def labelme2yolov2Seg(jsonfilePath="", resultDirPath="", classList=["railway"]):
    """
...
if __name__ == "__main__":
    jsonfilePath = r"D:\project\xpx\ultralytics-main\my_seg\json"  # 要转换的json文件所在目录
    resultDirPath = r"D:\project\xpx\ultralytics-main\my_seg\txt"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["railway"])  # 更改为自己的类别名
